            ...
            <div className='max-w-4/5 m-auto flex justify-between items-center'>
                ...
                <div>
                    <ul className='flex gap-4 font-medium'>
                        <Link to={"/leaderboard"}>
                            <li className='hover:font-bold'>Leaderboard</li>
                        </Link>
                        <Link to={"/report"}>
                            <li className='hover:font-bold'>Report Typo</li>
                        </Link>
                    </ul>
                </div>
                <div className='flex items-center gap-4'>
                    ...
                    <span>|</span>
                    <Link className='cursor-pointer hover:font-bold' to={'/login'}>Login</Link>
                    <Link>
