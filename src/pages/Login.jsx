    ...
    return (
        <main className="max-w-4/5 m-auto">
            <section className="mt-20 mb-12 text-center">
                ...
                <p className="mt-2 text-slate-500">Sign in to your Polisi Typo account</p>
            </section>
            <section>
                <div className="max-w-1/2 m-auto bg-white shadow-md border rounded-2xl border-slate-300 transition hover:shadow-xl hover:border-slate-400">
                    ...
                    <div className="px-6 flex justify-between">
                        <div className=" space-x-2">
                            ...
                            <label htmlFor="remember-me" className="text-slate-600 font-medium">Remember me</label>
                        </div>
                        <Link className="text-sky-800 hover:underline">Forgot password?</Link>
                    </div>
                    <div className="m-6">
                        <button className="w-full px-4 py-2 rounded-xl bg-primary text-white cursor-pointer transition hover:bg-sky-900">Sign In</button>
                    </div>
                </div>
            </section>
        </main>
