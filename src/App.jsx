          ...
          <div className='grid grid-cols-3 gap-4 mt-6'>
            ...
            <div className='bg-white p-6 rounded-2xl shadow-md border border-slate-300 transition hover:shadow-xl hover:border-slate-400'>
              ...
              <div className='mt-4 space-y-4'>
                <div>
                  ...
                  <p className='text-slate-600 line-through decoration-rose-500/50 decoration-2 de font-light'>Teh quick brown fox</p>
                </div>
                <div>
            ...
            <div className='bg-white p-6 rounded-2xl shadow-md border border-slate-300 transition hover:shadow-xl hover:border-slate-400'>
              <div className='flex justify-between items-start gap-8'>
                ...
                <p className='bg-gray-200 text-gray-800 px-3 py-1 rounded-2xl text-sm'>Pending</p>
              </div>
